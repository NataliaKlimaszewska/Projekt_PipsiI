            ...
            <div class="w-full p-8 lg:w-1/2">
                ...
                <form action="#" method="POST">
                    <div class="mb-4">
                        ...
                        <input type="text" id="username" name="username" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-pink-500" autocomplete="off">
                    </div>
                    <div class="mb-4">
